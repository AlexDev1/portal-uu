...
- [ ] Add an email address to the `ADMINS` settings variable in `uuportal/uuportal/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `uuportal/uuportal/settings/production.py`
...
- Create a copy of ``uuportal/settings/local.py.example``:  
  `cp uuportal/settings/local.py.example uuportal/settings/local.py` (remembering you should replace `uuportal` with your project's name!).
